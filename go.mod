module github.com/hashicorp/vault-plugin-database-db2

go 1.25.0

require (
	github.com/hashicorp/vault/sdk v0.20.0
	github.com/ibmdb/go_ibm_db v0.5.3
)
...
require (
	...
	github.com/ibmruntimes/go-recordio/v2 v2.0.0-20250505215253-37ac59a214d6 // indirect
